...
// Обновлённый обработчик статуса подключения (последняя версия)
tonConnectUI.onStatusChange(walletInfo => {
  ...
  if (walletInfo?.connected) {
    ...
    // Кнопка становится зелёной (класс connected)
    if (container) {
...
// Если кнопка TonConnect ещё не отрисована — принудительно рендерим без текста
